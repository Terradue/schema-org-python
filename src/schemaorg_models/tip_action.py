...
The act of giving money voluntarily to a beneficiary in recognition of services rendered.
    """
    type_: Literal['https://schema.org/TipAction'] = Field(default='https://schema.org/TipAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
