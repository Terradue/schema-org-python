...
Used to describe a seat, such as a reserved seat in an event reservation.
    """
    class_: Literal['https://schema.org/Seat'] = Field(default='https://schema.org/Seat', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
