...
A short TV or radio program or a segment/part of a program.
    """
    type_: Literal['https://schema.org/Clip'] = Field(default='https://schema.org/Clip', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
