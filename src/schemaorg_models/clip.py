...
A short TV or radio program or a segment/part of a program.
    """
    class_: Literal['https://schema.org/Clip'] = Field(default='https://schema.org/Clip', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    endOffset: Optional[Union["HyperTocEntry", List["HyperTocEntry"], float, List[float]]] = Field(default=None, validation_alias=AliasChoices('endOffset', 'https://schema.org/endOffset'), serialization_alias='https://schema.org/endOffset')
