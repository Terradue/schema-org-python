...
A collection of music tracks.
    """
    class_: Literal['https://schema.org/MusicAlbum'] = Field(default='https://schema.org/MusicAlbum', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
