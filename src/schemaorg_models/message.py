...
A single message from a sender to one or more organizations or people.
    """
    type_: Literal['https://schema.org/Message'] = Field(default='https://schema.org/Message', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
