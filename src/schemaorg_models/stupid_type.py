...
A StupidType for testing.
    """
    class_: Literal['https://schema.org/StupidType'] = Field(default='https://schema.org/StupidType', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
