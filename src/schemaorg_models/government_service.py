...
A service provided by a government organization, e.g. food stamps, veterans benefits, etc.
    """
    type_: Literal['https://schema.org/GovernmentService'] = Field(default='https://schema.org/GovernmentService', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
