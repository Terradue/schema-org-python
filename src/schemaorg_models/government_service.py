...
A service provided by a government organization, e.g. food stamps, veterans benefits, etc.
    """
    class_: Literal['https://schema.org/GovernmentService'] = Field(default='https://schema.org/GovernmentService', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
