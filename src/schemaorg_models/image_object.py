...
An image file.
    """
    class_: Literal['https://schema.org/ImageObject'] = Field(default='https://schema.org/ImageObject', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
