...
A type of blood vessel that specifically carries blood away from the heart.
    """
    class_: Literal['https://schema.org/Artery'] = Field(default='https://schema.org/Artery', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
