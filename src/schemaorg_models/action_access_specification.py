...
A set of requirements that must be fulfilled in order to perform an Action.
    """
    type_: Literal['https://schema.org/ActionAccessSpecification'] = Field(default='https://schema.org/ActionAccessSpecification', alias='@type', serialization_alias='@type') # type: ignore
