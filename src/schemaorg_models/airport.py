...
An airport.
    """
    class_: Literal['https://schema.org/Airport'] = Field(default='https://schema.org/Airport', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
