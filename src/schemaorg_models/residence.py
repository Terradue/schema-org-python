...
The place where a person lives.
    """
    type_: Literal['https://schema.org/Residence'] = Field(default='https://schema.org/Residence', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
