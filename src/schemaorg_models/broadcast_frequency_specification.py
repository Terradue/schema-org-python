...
The frequency in MHz and the modulation used for a particular BroadcastService.
    """
    class_: Literal['https://schema.org/BroadcastFrequencySpecification'] = Field(default='https://schema.org/BroadcastFrequencySpecification', alias='@type', serialization_alias='@type') # type: ignore
