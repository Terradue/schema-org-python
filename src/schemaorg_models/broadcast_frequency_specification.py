...
The frequency in MHz and the modulation used for a particular BroadcastService.
    """
    type_: Literal['https://schema.org/BroadcastFrequencySpecification'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/BroadcastFrequencySpecification'),serialization_alias='class') # type: ignore
