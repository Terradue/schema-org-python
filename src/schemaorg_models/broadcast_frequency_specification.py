...
The frequency in MHz and the modulation used for a particular BroadcastService.
    """
    class_: Literal['https://schema.org/BroadcastFrequencySpecification'] = Field(default='https://schema.org/BroadcastFrequencySpecification', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
