...
The frequency in MHz and the modulation used for a particular BroadcastService.
    """
    class_: Literal['https://schema.org/BroadcastFrequencySpecification'] = Field(default='https://schema.org/BroadcastFrequencySpecification', alias='class', serialization_alias='class') # type: ignore
