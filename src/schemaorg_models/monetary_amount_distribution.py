...
A statistical distribution of monetary amounts.
    """
    type_: Literal['https://schema.org/MonetaryAmountDistribution'] = Field(default='https://schema.org/MonetaryAmountDistribution', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
