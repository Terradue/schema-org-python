...
The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation.
    """
    type_: Literal['https://schema.org/CommunicateAction'] = Field(default='https://schema.org/CommunicateAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
