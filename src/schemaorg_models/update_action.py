...
The act of managing by changing/editing the state of the object.
    """
    type_: Literal['https://schema.org/UpdateAction'] = Field(default='https://schema.org/UpdateAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
