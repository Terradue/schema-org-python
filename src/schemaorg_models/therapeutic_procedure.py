...
A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition.
    """
    class_: Literal['https://schema.org/TherapeuticProcedure'] = Field(default='https://schema.org/TherapeuticProcedure', alias='@type', serialization_alias='@type') # type: ignore
