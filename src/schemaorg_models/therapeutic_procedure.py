...
A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition.
    """
    type_: Literal['https://schema.org/TherapeuticProcedure'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/TherapeuticProcedure'),serialization_alias='class') # type: ignore
