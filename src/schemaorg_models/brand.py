...
A brand is a name used by an organization or business person for labeling a product, product group, or similar.
    """
    class_: Literal['https://schema.org/Brand'] = Field(default='https://schema.org/Brand', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
