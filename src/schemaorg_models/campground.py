...
See also the dedicated [document on the use of schema.org for marking up hotels and other forms of accommodations](/docs/hotels.html).
    ...
    """
    type_: Literal['https://schema.org/Campground'] = Field(default='https://schema.org/Campground', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
