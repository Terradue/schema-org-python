...
A US-style health insurance plan network.
    """
    type_: Literal['https://schema.org/HealthPlanNetwork'] = Field(default='https://schema.org/HealthPlanNetwork', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
