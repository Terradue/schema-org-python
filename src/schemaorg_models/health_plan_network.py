...
A US-style health insurance plan network.
    """
    class_: Literal['https://schema.org/HealthPlanNetwork'] = Field(default='https://schema.org/HealthPlanNetwork', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
