...
A movie.
    """
    class_: Literal['https://schema.org/Movie'] = Field(default='https://schema.org/Movie', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
