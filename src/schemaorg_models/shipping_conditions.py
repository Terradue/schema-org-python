...
The conditions (constraints, price) applicable to the [[ShippingService]].
    """
    class_: Literal['https://schema.org/ShippingConditions'] = Field(default='https://schema.org/ShippingConditions', alias='class', serialization_alias='class') # type: ignore
