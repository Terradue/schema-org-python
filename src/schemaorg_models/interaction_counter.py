...
A summary of how users have interacted with this CreativeWork. In most cases, authors will use a subtype to specify the specific type of interaction.
    """
    type_: Literal['https://schema.org/InteractionCounter'] = Field(default='https://schema.org/InteractionCounter', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
