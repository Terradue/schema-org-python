...
A trip on a commercial bus line.
    """
    type_: Literal['https://schema.org/BusTrip'] = Field(default='https://schema.org/BusTrip', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
