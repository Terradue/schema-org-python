...
A trip on a commercial bus line.
    """
    class_: Literal['https://schema.org/BusTrip'] = Field(default='https://schema.org/BusTrip', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
