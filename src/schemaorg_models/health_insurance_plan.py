...
A US-style health insurance plan, including PPOs, EPOs, and HMOs.
    """
    class_: Literal['https://schema.org/HealthInsurancePlan'] = Field(default='https://schema.org/HealthInsurancePlan', alias='@type', serialization_alias='@type') # type: ignore
