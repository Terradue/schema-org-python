...
A US-style health insurance plan, including PPOs, EPOs, and HMOs.
    """
    class_: Literal['https://schema.org/HealthInsurancePlan'] = Field(default='https://schema.org/HealthInsurancePlan', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
