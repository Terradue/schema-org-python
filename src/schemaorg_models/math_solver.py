...
A math solver which is capable of solving a subset of mathematical problems.
    """
    type_: Literal['https://schema.org/MathSolver'] = Field(default='https://schema.org/MathSolver', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
