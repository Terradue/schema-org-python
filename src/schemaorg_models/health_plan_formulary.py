...
For a given health insurance plan, the specification for costs and coverage of prescription drugs.
    """
    class_: Literal['https://schema.org/HealthPlanFormulary'] = Field(default='https://schema.org/HealthPlanFormulary', alias='@type', serialization_alias='@type') # type: ignore
