...
Financial services business.
    """
    type_: Literal['https://schema.org/FinancialService'] = Field(default='https://schema.org/FinancialService', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
