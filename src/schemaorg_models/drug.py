...
Specifying a drug or medicine used in a medication procedure.
    """
    class_: Literal['https://schema.org/Drug'] = Field(default='https://schema.org/Drug', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    interactingDrug: Optional[Union["Drug", List["Drug"]]] = Field(default=None, validation_alias=AliasChoices('interactingDrug', 'https://schema.org/interactingDrug'), serialization_alias='https://schema.org/interactingDrug')
    isAvailableGenerically: Optional[Union[bool, List[bool]]] = Field(default=None, validation_alias=AliasChoices('isAvailableGenerically', 'https://schema.org/isAvailableGenerically'), serialization_alias='https://schema.org/isAvailableGenerically')
    ...
    overdosage: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('overdosage', 'https://schema.org/overdosage'), serialization_alias='https://schema.org/overdosage')
    ...
    rxcui: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('rxcui', 'https://schema.org/rxcui'), serialization_alias='https://schema.org/rxcui')
    pregnancyWarning: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('pregnancyWarning', 'https://schema.org/pregnancyWarning'), serialization_alias='https://schema.org/pregnancyWarning')
    relatedDrug: Optional[Union["Drug", List["Drug"]]] = Field(default=None, validation_alias=AliasChoices('relatedDrug', 'https://schema.org/relatedDrug'), serialization_alias='https://schema.org/relatedDrug')
    clinicalPharmacology: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('clinicalPharmacology', 'https://schema.org/clinicalPharmacology'), serialization_alias='https://schema.org/clinicalPharmacology')
    ...
    prescriptionStatus: Optional[Union["DrugPrescriptionStatus", List["DrugPrescriptionStatus"], str, List[str]]] = Field(default=None, validation_alias=AliasChoices('prescriptionStatus', 'https://schema.org/prescriptionStatus'), serialization_alias='https://schema.org/prescriptionStatus')
    nonProprietaryName: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('nonProprietaryName', 'https://schema.org/nonProprietaryName'), serialization_alias='https://schema.org/nonProprietaryName')
    dosageForm: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('dosageForm', 'https://schema.org/dosageForm'), serialization_alias='https://schema.org/dosageForm')
