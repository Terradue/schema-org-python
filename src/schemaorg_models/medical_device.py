...
Any object used in a medical capacity, such as to diagnose or treat a patient.
    """
    type_: Literal['https://schema.org/MedicalDevice'] = Field(default='https://schema.org/MedicalDevice', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
