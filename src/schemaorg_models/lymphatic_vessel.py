...
A type of blood vessel that specifically carries lymph fluid unidirectionally toward the heart.
    """
    type_: Literal['https://schema.org/LymphaticVessel'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/LymphaticVessel'),serialization_alias='class') # type: ignore
