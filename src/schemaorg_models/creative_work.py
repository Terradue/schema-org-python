...
The most generic kind of creative work, including books, movies, photographs, software programs, etc.
    """
    class_: Literal['https://schema.org/CreativeWork'] = Field(default='https://schema.org/CreativeWork', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    commentCount: Optional[Union[int, List[int]]] = Field(default=None, validation_alias=AliasChoices('commentCount', 'https://schema.org/commentCount'), serialization_alias='https://schema.org/commentCount')
    audio: Optional[Union["AudioObject", List["AudioObject"], "MusicRecording", List["MusicRecording"], "Clip", List["Clip"]]] = Field(default=None, validation_alias=AliasChoices('audio', 'https://schema.org/audio'), serialization_alias='https://schema.org/audio')
    ...
    contentLocation: Optional[Union[Place, List[Place]]] = Field(default=None, validation_alias=AliasChoices('contentLocation', 'https://schema.org/contentLocation'), serialization_alias='https://schema.org/contentLocation')
    ...
    accessModeSufficient: Optional[Union["ItemList", List["ItemList"]]] = Field(default=None, validation_alias=AliasChoices('accessModeSufficient', 'https://schema.org/accessModeSufficient'), serialization_alias='https://schema.org/accessModeSufficient')
    ...
    copyrightHolder: Optional[Union[Person, List[Person], "Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('copyrightHolder', 'https://schema.org/copyrightHolder'), serialization_alias='https://schema.org/copyrightHolder')
    hasPart: Optional[Union["CreativeWork", List["CreativeWork"]]] = Field(default=None, validation_alias=AliasChoices('hasPart', 'https://schema.org/hasPart'), serialization_alias='https://schema.org/hasPart')
    sourceOrganization: Optional[Union["Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('sourceOrganization', 'https://schema.org/sourceOrganization'), serialization_alias='https://schema.org/sourceOrganization')
    thumbnail: Optional[Union["ImageObject", List["ImageObject"]]] = Field(default=None, validation_alias=AliasChoices('thumbnail', 'https://schema.org/thumbnail'), serialization_alias='https://schema.org/thumbnail')
    ...
    accessibilityControl: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('accessibilityControl', 'https://schema.org/accessibilityControl'), serialization_alias='https://schema.org/accessibilityControl')
    ...
    timeRequired: Optional[Union["Duration", List["Duration"]]] = Field(default=None, validation_alias=AliasChoices('timeRequired', 'https://schema.org/timeRequired'), serialization_alias='https://schema.org/timeRequired')
    ...
    video: Optional[Union["VideoObject", List["VideoObject"], "Clip", List["Clip"]]] = Field(default=None, validation_alias=AliasChoices('video', 'https://schema.org/video'), serialization_alias='https://schema.org/video')
    ...
    creativeWorkStatus: Optional[Union["DefinedTerm", List["DefinedTerm"], str, List[str]]] = Field(default=None, validation_alias=AliasChoices('creativeWorkStatus', 'https://schema.org/creativeWorkStatus'), serialization_alias='https://schema.org/creativeWorkStatus')
    ...
    abstract: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('abstract', 'https://schema.org/abstract'), serialization_alias='https://schema.org/abstract')
    spatialCoverage: Optional[Union[Place, List[Place]]] = Field(default=None, validation_alias=AliasChoices('spatialCoverage', 'https://schema.org/spatialCoverage'), serialization_alias='https://schema.org/spatialCoverage')
    materialExtent: Optional[Union[str, List[str], "QuantitativeValue", List["QuantitativeValue"]]] = Field(default=None, validation_alias=AliasChoices('materialExtent', 'https://schema.org/materialExtent'), serialization_alias='https://schema.org/materialExtent')
    accessibilityHazard: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('accessibilityHazard', 'https://schema.org/accessibilityHazard'), serialization_alias='https://schema.org/accessibilityHazard')
    ...
    contentReferenceTime: Optional[Union[datetime, List[datetime]]] = Field(default=None, validation_alias=AliasChoices('contentReferenceTime', 'https://schema.org/contentReferenceTime'), serialization_alias='https://schema.org/contentReferenceTime')
    ...
    producer: Optional[Union[Person, List[Person], "Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('producer', 'https://schema.org/producer'), serialization_alias='https://schema.org/producer')
    ...
    interactivityType: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('interactivityType', 'https://schema.org/interactivityType'), serialization_alias='https://schema.org/interactivityType')
    ...
    character: Optional[Union[Person, List[Person]]] = Field(default=None, validation_alias=AliasChoices('character', 'https://schema.org/character'), serialization_alias='https://schema.org/character')
    text: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('text', 'https://schema.org/text'), serialization_alias='https://schema.org/text')
    ...
    spatial: Optional[Union[Place, List[Place]]] = Field(default=None, validation_alias=AliasChoices('spatial', 'https://schema.org/spatial'), serialization_alias='https://schema.org/spatial')
    workExample: Optional[Union["CreativeWork", List["CreativeWork"]]] = Field(default=None, validation_alias=AliasChoices('workExample', 'https://schema.org/workExample'), serialization_alias='https://schema.org/workExample')
    citation: Optional[Union[str, List[str], "CreativeWork", List["CreativeWork"]]] = Field(default=None, validation_alias=AliasChoices('citation', 'https://schema.org/citation'), serialization_alias='https://schema.org/citation')
    ...
    maintainer: Optional[Union[Person, List[Person], "Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('maintainer', 'https://schema.org/maintainer'), serialization_alias='https://schema.org/maintainer')
    ...
    editor: Optional[Union[Person, List[Person]]] = Field(default=None, validation_alias=AliasChoices('editor', 'https://schema.org/editor'), serialization_alias='https://schema.org/editor')
    encoding: Optional[Union["MediaObject", List["MediaObject"]]] = Field(default=None, validation_alias=AliasChoices('encoding', 'https://schema.org/encoding'), serialization_alias='https://schema.org/encoding')
    encodings: Optional[Union["MediaObject", List["MediaObject"]]] = Field(default=None, validation_alias=AliasChoices('encodings', 'https://schema.org/encodings'), serialization_alias='https://schema.org/encodings')
    ...
    copyrightNotice: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('copyrightNotice', 'https://schema.org/copyrightNotice'), serialization_alias='https://schema.org/copyrightNotice')
    ...
    locationCreated: Optional[Union[Place, List[Place]]] = Field(default=None, validation_alias=AliasChoices('locationCreated', 'https://schema.org/locationCreated'), serialization_alias='https://schema.org/locationCreated')
