...
A dataset contained in this catalog.
    """
    class_: Literal['https://schema.org/Dataset'] = Field(default='https://schema.org/Dataset', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
