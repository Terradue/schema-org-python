...
An individual physician or a physician's office considered as a [[MedicalOrganization]].
    """
    class_: Literal['https://schema.org/Physician'] = Field(default='https://schema.org/Physician', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
