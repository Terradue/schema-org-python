...
An individual physician or a physician's office considered as a [[MedicalOrganization]].
    """
    type_: Literal['https://schema.org/Physician'] = Field(default='https://schema.org/Physician', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
