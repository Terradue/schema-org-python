...
Reference documentation for application programming interfaces (APIs).
    """
    type_: Literal['https://schema.org/APIReference'] = Field(default='https://schema.org/APIReference', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
