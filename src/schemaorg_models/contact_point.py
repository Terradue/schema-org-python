...
A contact point for a person or organization.
    """
    type_: Literal['https://schema.org/ContactPoint'] = Field(default='https://schema.org/ContactPoint', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
    ...
    productSupported: Optional[Union[str, List[str], Product, List[Product]]] = Field(default=None, validation_alias=AliasChoices('productSupported', 'https://schema.org/productSupported'), serialization_alias='https://schema.org/productSupported')
    contactOption: Optional[Union[ContactPointOption, List[ContactPointOption]]] = Field(default=None, validation_alias=AliasChoices('contactOption', 'https://schema.org/contactOption'), serialization_alias='https://schema.org/contactOption')
    contactType: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('contactType', 'https://schema.org/contactType'), serialization_alias='https://schema.org/contactType')
