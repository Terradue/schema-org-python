...
An EducationalAudience.
    """
    class_: Literal['https://schema.org/EducationalAudience'] = Field(default='https://schema.org/EducationalAudience', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
