...
Should not be used where the nature of the alignment can be described using a simple property, for example to express that a resource [[teaches]] or [[assesses]] a competency.
    """
    type_: Literal['https://schema.org/AlignmentObject'] = Field(default='https://schema.org/AlignmentObject', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
