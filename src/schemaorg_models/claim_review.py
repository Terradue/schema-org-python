...
A fact-checking review of claims made (or reported) in some creative work (referenced via itemReviewed).
    """
    type_: Literal['https://schema.org/ClaimReview'] = Field(default='https://schema.org/ClaimReview', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
