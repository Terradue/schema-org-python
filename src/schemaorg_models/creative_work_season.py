...
A media season, e.g. TV, radio, video game etc.
    """
    class_: Literal['https://schema.org/CreativeWorkSeason'] = Field(default='https://schema.org/CreativeWorkSeason', alias='class', serialization_alias='class') # type: ignore
