...
A media season, e.g. TV, radio, video game etc.
    """
    type_: Literal['https://schema.org/CreativeWorkSeason'] = Field(default='https://schema.org/CreativeWorkSeason', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
