...
The act of asking someone to attend an event. Reciprocal of RsvpAction.
    """
    type_: Literal['https://schema.org/InviteAction'] = Field(default='https://schema.org/InviteAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
