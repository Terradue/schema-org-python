...
A strategy of regulating the intake of food to achieve or maintain a specific health-related goal.
    """
    type_: Literal['https://schema.org/Diet'] = Field(default='https://schema.org/Diet', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
