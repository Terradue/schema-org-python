...
The act of authoring written creative content.
    """
    type_: Literal['https://schema.org/WriteAction'] = Field(default='https://schema.org/WriteAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
