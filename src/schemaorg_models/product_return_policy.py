...
A ProductReturnPolicy provides information about product return policies associated with an [[Organization]] or [[Product]].
    """
    type_: Literal['https://schema.org/ProductReturnPolicy'] = Field(default='https://schema.org/ProductReturnPolicy', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
