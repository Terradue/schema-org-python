...
A ProductReturnPolicy provides information about product return policies associated with an [[Organization]] or [[Product]].
    """
    class_: Literal['https://schema.org/ProductReturnPolicy'] = Field(default='https://schema.org/ProductReturnPolicy', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
