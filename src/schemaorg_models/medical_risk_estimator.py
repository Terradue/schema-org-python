...
Any rule set or interactive tool for estimating the risk of developing a complication or condition.
    """
    class_: Literal['https://schema.org/MedicalRiskEstimator'] = Field(default='https://schema.org/MedicalRiskEstimator', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
