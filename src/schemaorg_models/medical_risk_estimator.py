...
Any rule set or interactive tool for estimating the risk of developing a complication or condition.
    """
    class_: Literal['https://schema.org/MedicalRiskEstimator'] = Field(default='https://schema.org/MedicalRiskEstimator', alias='class', serialization_alias='class') # type: ignore
