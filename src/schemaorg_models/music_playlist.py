...
A collection of music tracks in playlist form.
    """
    type_: Literal['https://schema.org/MusicPlaylist'] = Field(default='https://schema.org/MusicPlaylist', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
