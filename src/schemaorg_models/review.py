...
A review of the item.
    """
    class_: Literal['https://schema.org/Review'] = Field(default='https://schema.org/Review', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
