...
A review of the item.
    """
    type_: Literal['https://schema.org/Review'] = Field(default='https://schema.org/Review', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
