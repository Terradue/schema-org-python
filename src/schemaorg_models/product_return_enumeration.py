...
ProductReturnEnumeration enumerates several kinds of product return policy. Note that this structure may not capture all aspects of the policy.
    """
    type_: Literal['https://schema.org/ProductReturnEnumeration'] = Field(default='https://schema.org/ProductReturnEnumeration', alias='@type', serialization_alias='@type') # type: ignore
