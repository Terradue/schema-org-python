...
A podcast is an episodic series of digital audio or video files which a user can download and listen to.
    """
    type_: Literal['https://schema.org/PodcastSeries'] = Field(default='https://schema.org/PodcastSeries', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
