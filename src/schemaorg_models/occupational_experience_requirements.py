...
Indicates employment-related experience requirements, e.g. [[monthsOfExperience]].
    """
    class_: Literal['https://schema.org/OccupationalExperienceRequirements'] = Field(default='https://schema.org/OccupationalExperienceRequirements', alias='@type', serialization_alias='@type') # type: ignore
