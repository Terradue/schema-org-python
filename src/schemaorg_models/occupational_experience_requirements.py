...
Indicates employment-related experience requirements, e.g. [[monthsOfExperience]].
    """
    type_: Literal['https://schema.org/OccupationalExperienceRequirements'] = Field(default='https://schema.org/OccupationalExperienceRequirements', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
