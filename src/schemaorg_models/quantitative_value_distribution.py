...
A statistical distribution of values.
    """
    class_: Literal['https://schema.org/QuantitativeValueDistribution'] = Field(default='https://schema.org/QuantitativeValueDistribution', alias='class', serialization_alias='class') # type: ignore
