...
A statistical distribution of values.
    """
    type_: Literal['https://schema.org/QuantitativeValueDistribution'] = Field(default='https://schema.org/QuantitativeValueDistribution', alias='@type', serialization_alias='@type') # type: ignore
