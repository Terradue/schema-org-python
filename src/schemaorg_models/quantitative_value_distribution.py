...
A statistical distribution of values.
    """
    type_: Literal['https://schema.org/QuantitativeValueDistribution'] = Field(default='https://schema.org/QuantitativeValueDistribution', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
