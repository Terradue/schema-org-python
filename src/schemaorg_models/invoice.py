...
A statement of the money due for goods or services; a bill.
    """
    class_: Literal['https://schema.org/Invoice'] = Field(default='https://schema.org/Invoice', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
