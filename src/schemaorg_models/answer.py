...
An answer offered to a question; perhaps correct, perhaps opinionated or wrong.
    """
    type_: Literal['https://schema.org/Answer'] = Field(default='https://schema.org/Answer', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
