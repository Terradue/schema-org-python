...
A PerformanceRole is a Role that some entity places with regard to a theatrical performance, e.g. in a Movie, TVSeries etc.
    """
    type_: Literal['https://schema.org/PerformanceRole'] = Field(default='https://schema.org/PerformanceRole', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
