...
(Eventually to be defined as) a supertype of GeoShape designed to accommodate definitions from Geo-Spatial best practices.
    """
    class_: Literal['https://schema.org/GeospatialGeometry'] = Field(default='https://schema.org/GeospatialGeometry', alias='class', serialization_alias='class') # type: ignore
