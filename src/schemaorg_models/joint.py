...
The anatomical location at which two or more bones make contact.
    """
    class_: Literal['https://schema.org/Joint'] = Field(default='https://schema.org/Joint', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
