...
An organization such as a school, NGO, corporation, club, etc.
    """
    class_: Literal['https://schema.org/Organization'] = Field(default='https://schema.org/Organization', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    hasMemberProgram: Optional[Union["MemberProgram", List["MemberProgram"]]] = Field(default=None, validation_alias=AliasChoices('hasMemberProgram', 'https://schema.org/hasMemberProgram'), serialization_alias='https://schema.org/hasMemberProgram')
    ...
    subOrganization: Optional[Union["Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('subOrganization', 'https://schema.org/subOrganization'), serialization_alias='https://schema.org/subOrganization')
    ...
    nonprofitStatus: Optional[Union["NonprofitType", List["NonprofitType"]]] = Field(default=None, validation_alias=AliasChoices('nonprofitStatus', 'https://schema.org/nonprofitStatus'), serialization_alias='https://schema.org/nonprofitStatus')
    ...
    dissolutionDate: Optional[Union[date, List[date]]] = Field(default=None, validation_alias=AliasChoices('dissolutionDate', 'https://schema.org/dissolutionDate'), serialization_alias='https://schema.org/dissolutionDate')
    ...
    founder: Optional[Union["Organization", List["Organization"], Person, List[Person]]] = Field(default=None, validation_alias=AliasChoices('founder', 'https://schema.org/founder'), serialization_alias='https://schema.org/founder')
    ...
    legalAddress: Optional[Union["PostalAddress", List["PostalAddress"]]] = Field(default=None, validation_alias=AliasChoices('legalAddress', 'https://schema.org/legalAddress'), serialization_alias='https://schema.org/legalAddress')
    ...
    parentOrganization: Optional[Union["Organization", List["Organization"]]] = Field(default=None, validation_alias=AliasChoices('parentOrganization', 'https://schema.org/parentOrganization'), serialization_alias='https://schema.org/parentOrganization')
    ...
    legalName: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('legalName', 'https://schema.org/legalName'), serialization_alias='https://schema.org/legalName')
    ...
    employee: Optional[Union[Person, List[Person]]] = Field(default=None, validation_alias=AliasChoices('employee', 'https://schema.org/employee'), serialization_alias='https://schema.org/employee')
