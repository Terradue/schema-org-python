...
Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations.
    """
    type_: Literal['https://schema.org/FoodEstablishmentReservation'] = Field(default='https://schema.org/FoodEstablishmentReservation', alias='@type', serialization_alias='@type') # type: ignore
