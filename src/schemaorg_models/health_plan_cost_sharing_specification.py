...
A description of costs to the patient under a given network or formulary.
    """
    class_: Literal['https://schema.org/HealthPlanCostSharingSpecification'] = Field(default='https://schema.org/HealthPlanCostSharingSpecification', alias='@type', serialization_alias='@type') # type: ignore
