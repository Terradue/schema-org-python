...
A set of organisms asserted to represent a natural cohesive biological unit.
    """
    type_: Literal['https://schema.org/Taxon'] = Field(default='https://schema.org/Taxon', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
