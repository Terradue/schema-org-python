...
A datasheet or vendor specification of a product (in the sense of a prototypical description).
    """
    class_: Literal['https://schema.org/ProductModel'] = Field(default='https://schema.org/ProductModel', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
