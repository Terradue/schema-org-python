...
The act of notifying an event organizer as to whether you expect to attend the event.
    """
    type_: Literal['https://schema.org/RsvpAction'] = Field(default='https://schema.org/RsvpAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
