...
The act of notifying an event organizer as to whether you expect to attend the event.
    """
    class_: Literal['https://schema.org/RsvpAction'] = Field(default='https://schema.org/RsvpAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
