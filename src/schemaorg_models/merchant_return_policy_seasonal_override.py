...
A seasonal override of a return policy, for example used for holidays.
    """
    class_: Literal['https://schema.org/MerchantReturnPolicySeasonalOverride'] = Field(default='https://schema.org/MerchantReturnPolicySeasonalOverride', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
