...
Any biological, chemical, or biochemical thing. For example: a protein; a gene; a chemical; a synthetic chemical.
    """
    class_: Literal['https://schema.org/BioChemEntity'] = Field(default='https://schema.org/BioChemEntity', alias='class', serialization_alias='class') # type: ignore
    ...
    def isInvolvedInBiologicalProcess2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
    ...
    def hasRepresentation2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
    ...
    def hasMolecularFunction2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
    ...
    def isLocatedInSubcellularLocation2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
    ...
    def associatedDisease2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
