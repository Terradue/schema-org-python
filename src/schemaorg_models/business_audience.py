...
A set of characteristics belonging to businesses, e.g. who compose an item's target audience.
    """
    class_: Literal['https://schema.org/BusinessAudience'] = Field(default='https://schema.org/BusinessAudience', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
