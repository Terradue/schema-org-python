...
A set of characteristics belonging to businesses, e.g. who compose an item's target audience.
    """
    type_: Literal['https://schema.org/BusinessAudience'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/BusinessAudience'),serialization_alias='class') # type: ignore
