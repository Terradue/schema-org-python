...
A work of art that is primarily visual in character.
    """
    class_: Literal['https://schema.org/VisualArtwork'] = Field(default='https://schema.org/VisualArtwork', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
