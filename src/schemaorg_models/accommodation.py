...
See also the <a href="/docs/hotels.html">dedicated document on the use of schema.org for marking up hotels and other forms of accommodations</a>.
    ...
    """
    class_: Literal['https://schema.org/Accommodation'] = Field(default='https://schema.org/Accommodation', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    floorLevel: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('floorLevel', 'https://schema.org/floorLevel'), serialization_alias='https://schema.org/floorLevel')
    ...
    accommodationCategory: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('accommodationCategory', 'https://schema.org/accommodationCategory'), serialization_alias='https://schema.org/accommodationCategory')
    ...
    yearBuilt: Optional[Union[float, List[float]]] = Field(default=None, validation_alias=AliasChoices('yearBuilt', 'https://schema.org/yearBuilt'), serialization_alias='https://schema.org/yearBuilt')
