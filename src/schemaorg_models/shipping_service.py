...
ShippingService represents the criteria used to determine if and how an offer could be shipped to a customer.
    """
    type_: Literal['https://schema.org/ShippingService'] = Field(default='https://schema.org/ShippingService', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
