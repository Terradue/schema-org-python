...
A public structure, such as a town hall or concert hall.
    """
    type_: Literal['https://schema.org/CivicStructure'] = Field(default='https://schema.org/CivicStructure', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
