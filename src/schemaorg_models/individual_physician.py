...
The [[practicesAt]] property can be used to indicate [[MedicalOrganization]] hospitals, clinics, pharmacies etc. where this physician practices.
    """
    class_: Literal['https://schema.org/IndividualPhysician'] = Field(default='https://schema.org/IndividualPhysician', alias='class', serialization_alias='class') # type: ignore
