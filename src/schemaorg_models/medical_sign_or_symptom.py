...
Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective.
    """
    type_: Literal['https://schema.org/MedicalSignOrSymptom'] = Field(default='https://schema.org/MedicalSignOrSymptom', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
