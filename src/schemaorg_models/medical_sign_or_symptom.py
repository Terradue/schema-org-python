...
Any feature associated or not with a medical condition. In medicine a symptom is generally subjective while a sign is objective.
    """
    class_: Literal['https://schema.org/MedicalSignOrSymptom'] = Field(default='https://schema.org/MedicalSignOrSymptom', alias='@type', serialization_alias='@type') # type: ignore
