...
A set of products (either [[ProductGroup]]s or specific variants) that are listed together e.g. in an [[Offer]].
    """
    type_: Literal['https://schema.org/ProductCollection'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/ProductCollection'),serialization_alias='class') # type: ignore
