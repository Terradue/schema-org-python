...
A structured value indicating the quantity, unit of measurement, and business function of goods included in a bundle offer.
    """
    type_: Literal['https://schema.org/TypeAndQuantityNode'] = Field(default='https://schema.org/TypeAndQuantityNode', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
