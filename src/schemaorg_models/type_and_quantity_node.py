...
A structured value indicating the quantity, unit of measurement, and business function of goods included in a bundle offer.
    """
    class_: Literal['https://schema.org/TypeAndQuantityNode'] = Field(default='https://schema.org/TypeAndQuantityNode', alias='class', serialization_alias='class') # type: ignore
