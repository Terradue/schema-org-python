...
A structured value providing information about when a certain organization or person owned a certain product.
    """
    type_: Literal['https://schema.org/OwnershipInfo'] = Field(default='https://schema.org/OwnershipInfo', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
