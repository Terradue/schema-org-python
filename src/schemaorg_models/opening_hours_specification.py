...
The opening hours of a certain place.
    """
    class_: Literal['https://schema.org/OpeningHoursSpecification'] = Field(default='https://schema.org/OpeningHoursSpecification', alias='@type', serialization_alias='@type') # type: ignore
