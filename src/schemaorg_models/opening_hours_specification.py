...
The opening hours of a certain place.
    """
    class_: Literal['https://schema.org/OpeningHoursSpecification'] = Field(default='https://schema.org/OpeningHoursSpecification', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
