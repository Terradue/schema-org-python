...
Used to describe a ticket to an event, a flight, a bus ride, etc.
    """
    type_: Literal['https://schema.org/Ticket'] = Field(default='https://schema.org/Ticket', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
