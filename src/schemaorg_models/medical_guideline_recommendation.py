...
A guideline recommendation that is regarded as efficacious and where quality of the data supporting the recommendation is sound.
    """
    type_: Literal['https://schema.org/MedicalGuidelineRecommendation'] = Field(default='https://schema.org/MedicalGuidelineRecommendation', alias='@type', serialization_alias='@type') # type: ignore
