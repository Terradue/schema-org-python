...
A guideline recommendation that is regarded as efficacious and where quality of the data supporting the recommendation is sound.
    """
    type_: Literal['https://schema.org/MedicalGuidelineRecommendation'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/MedicalGuidelineRecommendation'),serialization_alias='class') # type: ignore
