...
The geographic coordinates of a place or event.
    """
    type_: Literal['https://schema.org/GeoCoordinates'] = Field(default='https://schema.org/GeoCoordinates', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
