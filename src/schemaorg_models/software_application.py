...
A software application.
    """
    class_: Literal['https://schema.org/SoftwareApplication'] = Field(default='https://schema.org/SoftwareApplication', alias='@type', serialization_alias='@type') # type: ignore
