...
A software application.
    """
    type_: Literal['https://schema.org/SoftwareApplication'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/SoftwareApplication'),serialization_alias='class') # type: ignore
