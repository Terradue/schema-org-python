...
A software application.
    """
    type_: Literal['https://schema.org/SoftwareApplication'] = Field(default='https://schema.org/SoftwareApplication', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
