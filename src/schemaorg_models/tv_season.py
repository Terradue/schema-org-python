...
Season dedicated to TV broadcast and associated online delivery.
    """
    type_: Literal['https://schema.org/TVSeason'] = Field(default='https://schema.org/TVSeason', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
