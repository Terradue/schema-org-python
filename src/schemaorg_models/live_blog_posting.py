...
A [[LiveBlogPosting]] is a [[BlogPosting]] intended to provide a rolling textual coverage of an ongoing event through continuous updates.
    """
    type_: Literal['https://schema.org/LiveBlogPosting'] = Field(default='https://schema.org/LiveBlogPosting', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
