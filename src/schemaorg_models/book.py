...
A book.
    """
    class_: Literal['https://schema.org/Book'] = Field(default='https://schema.org/Book', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
