...
Upcoming or past event associated with this place, organization, or action.
    """
    class_: Literal['https://schema.org/Event'] = Field(default='https://schema.org/Event', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
