...
Information about the engine of the vehicle. A vehicle can have multiple engines represented by multiple engine specification entities.
    """
    type_: Literal['https://schema.org/EngineSpecification'] = Field(default='https://schema.org/EngineSpecification', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
