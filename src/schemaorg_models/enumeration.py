...
Lists or enumerations—for example, a list of cuisines or music genres, etc.
    """
    type_: Literal['https://schema.org/Enumeration'] = Field(default='https://schema.org/Enumeration', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
