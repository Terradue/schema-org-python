...
A music recording (track), usually a single song.
    """
    type_: Literal['https://schema.org/MusicRecording'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/MusicRecording'),serialization_alias='class') # type: ignore
