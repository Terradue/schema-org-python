...
A structured value representing exchange rate.
    """
    type_: Literal['https://schema.org/ExchangeRateSpecification'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/ExchangeRateSpecification'),serialization_alias='class') # type: ignore
