...
A structured value representing exchange rate.
    """
    class_: Literal['https://schema.org/ExchangeRateSpecification'] = Field(default='https://schema.org/ExchangeRateSpecification', alias='@type', serialization_alias='@type') # type: ignore
