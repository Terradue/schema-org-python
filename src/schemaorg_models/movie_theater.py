...
A movie theater.
    """
    class_: Literal['https://schema.org/MovieTheater'] = Field(default='https://schema.org/MovieTheater', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
