...
A direction indicating a single action to do in the instructions for how to achieve a result.
    """
    type_: Literal['https://schema.org/HowToDirection'] = Field(default='https://schema.org/HowToDirection', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
