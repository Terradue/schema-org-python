...
A subclass of OrganizationRole used to describe employee relationships.
    """
    type_: Literal['https://schema.org/EmployeeRole'] = Field(default='https://schema.org/EmployeeRole', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
