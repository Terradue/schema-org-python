...
The amount of a [[Grant]] is represented using [[amount]] as a [[MonetaryAmount]].
    ...
    """
    type_: Literal['https://schema.org/Grant'] = Field(default='https://schema.org/Grant', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
