...
A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement.
    """
    type_: Literal['https://schema.org/Muscle'] = Field(default='https://schema.org/Muscle', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
