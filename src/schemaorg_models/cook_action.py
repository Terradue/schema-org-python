...
The act of producing/preparing food.
    """
    type_: Literal['https://schema.org/CookAction'] = Field(default='https://schema.org/CookAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
