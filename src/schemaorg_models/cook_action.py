...
The act of producing/preparing food.
    """
    class_: Literal['https://schema.org/CookAction'] = Field(default='https://schema.org/CookAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
