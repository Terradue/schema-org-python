...
A sub property of instrument. The recipe/instructions used to perform the action.
    """
    type_: Literal['https://schema.org/Recipe'] = Field(default='https://schema.org/Recipe', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
