...
A trip or journey. An itinerary of visits to one or more places.
    """
    class_: Literal['https://schema.org/Trip'] = Field(default='https://schema.org/Trip', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
