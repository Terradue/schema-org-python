...
A trip or journey. An itinerary of visits to one or more places.
    """
    type_: Literal['https://schema.org/Trip'] = Field(default='https://schema.org/Trip', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
