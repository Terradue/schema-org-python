...
The act of transferring/moving (abstract or concrete) animate or inanimate objects from one place to another.
    """
    class_: Literal['https://schema.org/TransferAction'] = Field(default='https://schema.org/TransferAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
