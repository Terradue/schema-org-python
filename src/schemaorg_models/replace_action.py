...
The act of editing a recipient by replacing an old object with a new object.
    """
    class_: Literal['https://schema.org/ReplaceAction'] = Field(default='https://schema.org/ReplaceAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
