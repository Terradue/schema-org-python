...
A specific strength in which a medical drug is available in a specific country.
    """
    type_: Literal['https://schema.org/DrugStrength'] = Field(default='https://schema.org/DrugStrength', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
