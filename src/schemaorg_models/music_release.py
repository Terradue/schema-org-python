...
A MusicRelease is a specific release of a music album.
    """
    type_: Literal['https://schema.org/MusicRelease'] = Field(default='https://schema.org/MusicRelease', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
