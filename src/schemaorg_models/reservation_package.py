...
A group of multiple reservations with common values for all sub-reservations.
    """
    class_: Literal['https://schema.org/ReservationPackage'] = Field(default='https://schema.org/ReservationPackage', alias='class', serialization_alias='class') # type: ignore
