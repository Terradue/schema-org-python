...
A single feed providing structured information about one or more entities or topics.
    """
    class_: Literal['https://schema.org/DataFeed'] = Field(default='https://schema.org/DataFeed', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
