...
The price asked for a given offer by the respective organization or person.
    """
    class_: Literal['https://schema.org/UnitPriceSpecification'] = Field(default='https://schema.org/UnitPriceSpecification', alias='@type', serialization_alias='@type') # type: ignore
