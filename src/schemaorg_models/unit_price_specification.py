...
The price asked for a given offer by the respective organization or person.
    """
    class_: Literal['https://schema.org/UnitPriceSpecification'] = Field(default='https://schema.org/UnitPriceSpecification', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
