...
Any part of the human body, typically a component of an anatomical system. Organs, tissues, and cells are all anatomical structures.
    """
    type_: Literal['https://schema.org/AnatomicalStructure'] = Field(default='https://schema.org/AnatomicalStructure', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
