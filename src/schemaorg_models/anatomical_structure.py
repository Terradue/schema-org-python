...
Any part of the human body, typically a component of an anatomical system. Organs, tissues, and cells are all anatomical structures.
    """
    class_: Literal['https://schema.org/AnatomicalStructure'] = Field(default='https://schema.org/AnatomicalStructure', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    connectedTo: Optional[Union["AnatomicalStructure", List["AnatomicalStructure"]]] = Field(default=None, validation_alias=AliasChoices('connectedTo', 'https://schema.org/connectedTo'), serialization_alias='https://schema.org/connectedTo')
    ...
    partOfSystem: Optional[Union["AnatomicalSystem", List["AnatomicalSystem"]]] = Field(default=None, validation_alias=AliasChoices('partOfSystem', 'https://schema.org/partOfSystem'), serialization_alias='https://schema.org/partOfSystem')
