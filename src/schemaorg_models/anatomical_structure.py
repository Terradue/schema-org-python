...
Any part of the human body, typically a component of an anatomical system. Organs, tissues, and cells are all anatomical structures.
    """
    class_: Literal['https://schema.org/AnatomicalStructure'] = Field(default='https://schema.org/AnatomicalStructure', alias='@type', serialization_alias='@type') # type: ignore
