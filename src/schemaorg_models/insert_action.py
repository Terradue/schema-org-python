...
The act of adding at a specific location in an ordered collection.
    """
    class_: Literal['https://schema.org/InsertAction'] = Field(default='https://schema.org/InsertAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
