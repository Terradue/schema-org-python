...
media type information, e.g. "application/rss+xml" or "application/atom+xml".
    ...
    """
    class_: Literal['https://schema.org/SpecialAnnouncement'] = Field(default='https://schema.org/SpecialAnnouncement', alias='class', serialization_alias='class') # type: ignore
