...
A collection of items, e.g. creative works or products.
    """
    type_: Literal['https://schema.org/Collection'] = Field(default='https://schema.org/Collection', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
