...
A hospital.
    """
    class_: Literal['https://schema.org/Hospital'] = Field(default='https://schema.org/Hospital', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
