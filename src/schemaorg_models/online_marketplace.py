...
An eCommerce marketplace.
    """
    type_: Literal['https://schema.org/OnlineMarketplace'] = Field(default='https://schema.org/OnlineMarketplace', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
