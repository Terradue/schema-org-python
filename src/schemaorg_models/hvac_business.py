...
A business that provides Heating, Ventilation and Air Conditioning services.
    """
    type_: Literal['https://schema.org/HVACBusiness'] = Field(default='https://schema.org/HVACBusiness', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
