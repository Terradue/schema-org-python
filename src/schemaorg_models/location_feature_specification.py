...
Specifies a location feature by providing a structured value representing a feature of an accommodation as a property-value pair of varying degrees of formality.
    """
    class_: Literal['https://schema.org/LocationFeatureSpecification'] = Field(default='https://schema.org/LocationFeatureSpecification', alias='@type', serialization_alias='@type') # type: ignore
