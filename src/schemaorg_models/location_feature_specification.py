...
Specifies a location feature by providing a structured value representing a feature of an accommodation as a property-value pair of varying degrees of formality.
    """
    type_: Literal['https://schema.org/LocationFeatureSpecification'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/LocationFeatureSpecification'),serialization_alias='class') # type: ignore
