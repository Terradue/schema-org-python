...
A patient is any person recipient of health care services.
    """
    type_: Literal['https://schema.org/Patient'] = Field(default='https://schema.org/Patient', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
