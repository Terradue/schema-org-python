...
A delivery service through which content is provided via broadcast over the air or online.
    """
    class_: Literal['https://schema.org/BroadcastService'] = Field(default='https://schema.org/BroadcastService', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    area: Optional[Union[Place, List[Place]]] = Field(default=None, validation_alias=AliasChoices('area', 'https://schema.org/area'), serialization_alias='https://schema.org/area')
    ...
    broadcastDisplayName: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('broadcastDisplayName', 'https://schema.org/broadcastDisplayName'), serialization_alias='https://schema.org/broadcastDisplayName')
    ...
    hasBroadcastChannel: Optional[Union[BroadcastChannel, List[BroadcastChannel]]] = Field(default=None, validation_alias=AliasChoices('hasBroadcastChannel', 'https://schema.org/hasBroadcastChannel'), serialization_alias='https://schema.org/hasBroadcastChannel')
    parentService: Optional[Union["BroadcastService", List["BroadcastService"]]] = Field(default=None, validation_alias=AliasChoices('parentService', 'https://schema.org/parentService'), serialization_alias='https://schema.org/parentService')
    broadcastTimezone: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('broadcastTimezone', 'https://schema.org/broadcastTimezone'), serialization_alias='https://schema.org/broadcastTimezone')
