...
A WebSite is a set of related web pages and other items typically served from a single web domain and accessible via URLs.
    """
    type_: Literal['https://schema.org/WebSite'] = Field(default='https://schema.org/WebSite', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
