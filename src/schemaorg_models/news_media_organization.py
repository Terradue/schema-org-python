...
A News/Media organization such as a newspaper or TV station.
    """
    class_: Literal['https://schema.org/NewsMediaOrganization'] = Field(default='https://schema.org/NewsMediaOrganization', alias='@type', serialization_alias='@type') # type: ignore
