...
A News/Media organization such as a newspaper or TV station.
    ...
    def noBylinesPolicy2str(self, val) -> str:
        if isinstance(val, HttpUrl): ### This magic! If isinstance(val, HttpUrl) - error
            return str(val)
        return val
    ...
    def missionCoveragePrioritiesPolicy2str(self, val) -> str:
        if isinstance(val, HttpUrl): ### This magic! If isinstance(val, HttpUrl) - error
            return str(val)
        return val
    ...
    def verificationFactCheckingPolicy2str(self, val) -> str:
        if isinstance(val, HttpUrl): ### This magic! If isinstance(val, HttpUrl) - error
            return str(val)
        return val
