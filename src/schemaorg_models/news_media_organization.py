...
A News/Media organization such as a newspaper or TV station.
    """
    class_: Literal['https://schema.org/NewsMediaOrganization'] = Field(default='https://schema.org/NewsMediaOrganization', alias='class', serialization_alias='class') # type: ignore
