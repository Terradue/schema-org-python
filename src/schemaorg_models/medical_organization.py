...
A medical organization (physical or not), such as hospital, institution or clinic.
    """
    type_: Literal['https://schema.org/MedicalOrganization'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/MedicalOrganization'),serialization_alias='class') # type: ignore
