...
A medical organization (physical or not), such as hospital, institution or clinic.
    """
    class_: Literal['https://schema.org/MedicalOrganization'] = Field(default='https://schema.org/MedicalOrganization', alias='@type', serialization_alias='@type') # type: ignore
