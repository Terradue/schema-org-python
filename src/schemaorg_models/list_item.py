...
An list item, e.g. a step in a checklist or how-to description.
    """
    class_: Literal['https://schema.org/ListItem'] = Field(default='https://schema.org/ListItem', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
