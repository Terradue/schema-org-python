...
The costs of settling the payment using a particular payment method.
    """
    type_: Literal['https://schema.org/PaymentChargeSpecification'] = Field(default='https://schema.org/PaymentChargeSpecification', alias='@type', serialization_alias='@type') # type: ignore
