...
The costs of settling the payment using a particular payment method.
    """
    type_: Literal['https://schema.org/PaymentChargeSpecification'] = Field(default='https://schema.org/PaymentChargeSpecification', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
