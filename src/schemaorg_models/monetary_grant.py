...
A monetary grant.
    """
    class_: Literal['https://schema.org/MonetaryGrant'] = Field(default='https://schema.org/MonetaryGrant', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
