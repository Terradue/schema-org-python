...
A monetary grant.
    """
    type_: Literal['https://schema.org/MonetaryGrant'] = Field(default='https://schema.org/MonetaryGrant', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
