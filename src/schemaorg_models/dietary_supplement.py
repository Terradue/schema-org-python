...
A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites.
    """
    class_: Literal['https://schema.org/DietarySupplement'] = Field(default='https://schema.org/DietarySupplement', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    recommendedIntake: Optional[Union["RecommendedDoseSchedule", List["RecommendedDoseSchedule"]]] = Field(default=None, validation_alias=AliasChoices('recommendedIntake', 'https://schema.org/recommendedIntake'), serialization_alias='https://schema.org/recommendedIntake')
    safetyConsideration: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('safetyConsideration', 'https://schema.org/safetyConsideration'), serialization_alias='https://schema.org/safetyConsideration')
