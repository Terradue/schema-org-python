...
A listing that describes a job opening in a certain organization.
    """
    class_: Literal['https://schema.org/JobPosting'] = Field(default='https://schema.org/JobPosting', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    workHours: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('workHours', 'https://schema.org/workHours'), serialization_alias='https://schema.org/workHours')
    applicantLocationRequirements: Optional[Union[AdministrativeArea, List[AdministrativeArea]]] = Field(default=None, validation_alias=AliasChoices('applicantLocationRequirements', 'https://schema.org/applicantLocationRequirements'), serialization_alias='https://schema.org/applicantLocationRequirements')
    ...
    jobImmediateStart: Optional[Union[bool, List[bool]]] = Field(default=None, validation_alias=AliasChoices('jobImmediateStart', 'https://schema.org/jobImmediateStart'), serialization_alias='https://schema.org/jobImmediateStart')
    title: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('title', 'https://schema.org/title'), serialization_alias='https://schema.org/title')
    employmentType: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('employmentType', 'https://schema.org/employmentType'), serialization_alias='https://schema.org/employmentType')
    ...
    def sensoryRequirement2str(self, val) -> str | List[str]:
        def _to_str(value):
    ...
    def physicalRequirement2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
    ...
    eligibilityToWorkRequirement: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('eligibilityToWorkRequirement', 'https://schema.org/eligibilityToWorkRequirement'), serialization_alias='https://schema.org/eligibilityToWorkRequirement')
    jobStartDate: Optional[Union[date, List[date], str, List[str]]] = Field(default=None, validation_alias=AliasChoices('jobStartDate', 'https://schema.org/jobStartDate'), serialization_alias='https://schema.org/jobStartDate')
    specialCommitments: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('specialCommitments', 'https://schema.org/specialCommitments'), serialization_alias='https://schema.org/specialCommitments')
    incentiveCompensation: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('incentiveCompensation', 'https://schema.org/incentiveCompensation'), serialization_alias='https://schema.org/incentiveCompensation')
    ...
    employmentUnit: Optional[Union[Organization, List[Organization]]] = Field(default=None, validation_alias=AliasChoices('employmentUnit', 'https://schema.org/employmentUnit'), serialization_alias='https://schema.org/employmentUnit')
    hiringOrganization: Optional[Union[Person, List[Person], Organization, List[Organization]]] = Field(default=None, validation_alias=AliasChoices('hiringOrganization', 'https://schema.org/hiringOrganization'), serialization_alias='https://schema.org/hiringOrganization')
    jobLocationType: Optional[Union[str, List[str]]] = Field(default=None, validation_alias=AliasChoices('jobLocationType', 'https://schema.org/jobLocationType'), serialization_alias='https://schema.org/jobLocationType')
    ...
    def securityClearanceRequirement2str(self, val) -> str | List[str]:
        def _to_str(value):
            if isinstance(value, HttpUrl):
                return str(value)
            return value
