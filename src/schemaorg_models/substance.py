...
Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical.
    """
    type_: Literal['https://schema.org/Substance'] = Field(default='https://schema.org/Substance', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
