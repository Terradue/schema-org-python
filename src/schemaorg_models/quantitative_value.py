...
class QuantitativeValue(StructuredValue):
 ...
 A point value or interval for product characteristics and other purposes.
    """
    class_: Literal['https://schema.org/QuantitativeValue'] = Field(default='https://schema.org/QuantitativeValue', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
