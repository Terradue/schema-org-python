...
Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations.
    """
    class_: Literal['https://schema.org/SportsOrganization'] = Field(default='https://schema.org/SportsOrganization', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
