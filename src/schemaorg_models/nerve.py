...
The underlying innervation associated with the muscle.
    """
    type_: Literal['https://schema.org/Nerve'] = Field(default='https://schema.org/Nerve', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
