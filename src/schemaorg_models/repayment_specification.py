...
A structured value representing repayment.
    """
    class_: Literal['https://schema.org/RepaymentSpecification'] = Field(default='https://schema.org/RepaymentSpecification', alias='@type', serialization_alias='@type') # type: ignore
