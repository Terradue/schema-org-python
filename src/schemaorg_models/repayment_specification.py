...
A structured value representing repayment.
    """
    type_: Literal['https://schema.org/RepaymentSpecification'] = Field(default='https://schema.org/RepaymentSpecification', alias='@type', serialization_alias='@type') # type: ignore
