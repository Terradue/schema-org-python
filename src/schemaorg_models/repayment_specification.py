...
A structured value representing repayment.
    """
    class_: Literal['https://schema.org/RepaymentSpecification'] = Field(default='https://schema.org/RepaymentSpecification', alias='class', serialization_alias='class') # type: ignore
