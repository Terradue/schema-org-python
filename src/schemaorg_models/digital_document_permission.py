...
A permission for a particular person or group to access a particular file.
    """
    class_: Literal['https://schema.org/DigitalDocumentPermission'] = Field(default='https://schema.org/DigitalDocumentPermission', alias='class', serialization_alias='class') # type: ignore
