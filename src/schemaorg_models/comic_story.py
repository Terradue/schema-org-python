...
The term "story" is any indivisible, re-printable
    ...
    """
    type_: Literal['https://schema.org/ComicStory'] = Field(default='https://schema.org/ComicStory', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
