...
The act of expressing a preference from a fixed/finite/structured set of choices/options.
    """
    class_: Literal['https://schema.org/VoteAction'] = Field(default='https://schema.org/VoteAction', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
