...
A medical laboratory that offers on-site or off-site diagnostic services.
    """
    type_: Literal['https://schema.org/DiagnosticLab'] = Field(default='https://schema.org/DiagnosticLab', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
