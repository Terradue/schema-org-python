...
An event involving the delivery of an item.
    """
    type_: Literal['https://schema.org/DeliveryEvent'] = Field(default='https://schema.org/DeliveryEvent', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
