...
A profession, may involve prolonged training and/or a formal qualification.
    """
    type_: Literal['https://schema.org/Occupation'] = Field(default='https://schema.org/Occupation', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
