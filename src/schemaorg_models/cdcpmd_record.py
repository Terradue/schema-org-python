...
A CDCPMDRecord is a data structure representing a record in a CDC tabular data format
    ...
    """
    class_: Literal['https://schema.org/CDCPMDRecord'] = Field(default='https://schema.org/CDCPMDRecord', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
