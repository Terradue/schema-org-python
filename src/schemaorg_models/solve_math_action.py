...
The action that takes in a math expression and directs users to a page potentially capable of solving/simplifying that expression.
    """
    type_: Literal['https://schema.org/SolveMathAction'] = Field(default='https://schema.org/SolveMathAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
