...
All or part of a [[Dataset]] in downloadable form. 
    """
    type_: Literal['https://schema.org/DataDownload'] = Field(default='https://schema.org/DataDownload', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
