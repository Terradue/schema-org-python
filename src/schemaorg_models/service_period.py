...
ServicePeriod represents a duration with some constraints about cutoff time and business days. This is used e.g. in shipping for handling times or transit time.
    """
    type_: Literal['https://schema.org/ServicePeriod'] = Field(default='https://schema.org/ServicePeriod', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
