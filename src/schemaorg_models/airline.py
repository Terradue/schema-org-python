...
An organization that provides flights for passengers.
    """
    class_: Literal['https://schema.org/Airline'] = Field(default='https://schema.org/Airline', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
