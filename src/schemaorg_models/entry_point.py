...
An entry point, within some Web-based protocol.
    """
    class_: Literal['https://schema.org/EntryPoint'] = Field(default='https://schema.org/EntryPoint', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
