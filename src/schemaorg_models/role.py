...
See also [blog post](https://blog.schema.org/2014/06/16/introducing-role/).
    """
    class_: Literal['https://schema.org/Role'] = Field(default='https://schema.org/Role', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
