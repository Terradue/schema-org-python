...
A unique instance of a BroadcastService on a CableOrSatelliteService lineup.
    """
    type_: Literal['https://schema.org/BroadcastChannel'] = Field(default='https://schema.org/BroadcastChannel', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
