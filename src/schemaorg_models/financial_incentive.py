...
<p>Optionally contains criteria on whether the incentive is limited based on [[purchaseType]], [[purchasePriceLimit]], [[incomeLimit]], and the [[qualifiedExpense]].
    ...
    """
    class_: Literal['https://schema.org/FinancialIncentive'] = Field(default='https://schema.org/FinancialIncentive', alias='class', serialization_alias='class') # type: ignore
