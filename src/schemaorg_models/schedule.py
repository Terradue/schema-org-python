...
A schedule defines a repeating time period used to describe a regularly occurring [[Event]]. At a minimum a schedule will specify [[repeatFrequency]] which describes the interval between occurrences of the event. Additional information can be provided to specify the schedule more precisely.
    ...
    """
    class_: Literal['https://schema.org/Schedule'] = Field(default='https://schema.org/Schedule', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
    ...
    exceptDate: Optional[Union[datetime, List[datetime], date, List[date]]] = Field(default=None, validation_alias=AliasChoices('exceptDate', 'https://schema.org/exceptDate'), serialization_alias='https://schema.org/exceptDate')
    byDay: Optional[Union[str, List[str], "DayOfWeek", List["DayOfWeek"]]] = Field(default=None, validation_alias=AliasChoices('byDay', 'https://schema.org/byDay'), serialization_alias='https://schema.org/byDay')
    byMonthDay: Optional[Union[int, List[int]]] = Field(default=None, validation_alias=AliasChoices('byMonthDay', 'https://schema.org/byMonthDay'), serialization_alias='https://schema.org/byMonthDay')
    ...
    repeatCount: Optional[Union[int, List[int]]] = Field(default=None, validation_alias=AliasChoices('repeatCount', 'https://schema.org/repeatCount'), serialization_alias='https://schema.org/repeatCount')
    byMonthWeek: Optional[Union[int, List[int]]] = Field(default=None, validation_alias=AliasChoices('byMonthWeek', 'https://schema.org/byMonthWeek'), serialization_alias='https://schema.org/byMonthWeek')
    byMonth: Optional[Union[int, List[int]]] = Field(default=None, validation_alias=AliasChoices('byMonth', 'https://schema.org/byMonth'), serialization_alias='https://schema.org/byMonth')
