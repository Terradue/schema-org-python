...
A means for accessing a service, e.g. a government office location, web site, or phone number.
    """
    type_: Literal['https://schema.org/ServiceChannel'] = Field(default='https://schema.org/ServiceChannel', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
