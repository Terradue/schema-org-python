...
Indicates a range of postal codes, usually defined as the set of valid codes between [[postalCodeBegin]] and [[postalCodeEnd]], inclusively.
    """
    type_: Literal['https://schema.org/PostalCodeRangeSpecification'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/PostalCodeRangeSpecification'),serialization_alias='class') # type: ignore
