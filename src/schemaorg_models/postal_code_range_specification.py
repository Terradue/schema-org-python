...
Indicates a range of postal codes, usually defined as the set of valid codes between [[postalCodeBegin]] and [[postalCodeEnd]], inclusively.
    """
    class_: Literal['https://schema.org/PostalCodeRangeSpecification'] = Field(default='https://schema.org/PostalCodeRangeSpecification', alias='class', serialization_alias='class') # type: ignore
