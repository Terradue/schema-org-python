...
A loan in which property or real estate is used as collateral. (A loan securitized against some real estate.)
    """
    class_: Literal['https://schema.org/MortgageLoan'] = Field(default='https://schema.org/MortgageLoan', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
