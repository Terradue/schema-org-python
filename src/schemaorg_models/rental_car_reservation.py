...
Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations.
    """
    type_: Literal['https://schema.org/RentalCarReservation'] = Field(default='https://schema.org/RentalCarReservation', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
