...
A web page element, like a table or an image.
    """
    type_: Literal['https://schema.org/WebPageElement'] = Field(default='https://schema.org/WebPageElement', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
