...
The legal availability status of a medical drug.
    """
    class_: Literal['https://schema.org/DrugLegalStatus'] = Field(default='https://schema.org/DrugLegalStatus', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
