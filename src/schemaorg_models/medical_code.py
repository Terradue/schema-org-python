...
A code for a medical entity.
    """
    type_: Literal['https://schema.org/MedicalCode'] = Field(default='https://schema.org/MedicalCode', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
