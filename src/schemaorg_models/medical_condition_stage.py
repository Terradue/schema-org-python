...
A stage of a medical condition, such as 'Stage IIIa'.
    """
    type_: Literal['https://schema.org/MedicalConditionStage'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/MedicalConditionStage'),serialization_alias='class') # type: ignore
