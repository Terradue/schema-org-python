...
A stage of a medical condition, such as 'Stage IIIa'.
    """
    class_: Literal['https://schema.org/MedicalConditionStage'] = Field(default='https://schema.org/MedicalConditionStage', alias='@type', serialization_alias='@type') # type: ignore
