...
A stage of a medical condition, such as 'Stage IIIa'.
    """
    class_: Literal['https://schema.org/MedicalConditionStage'] = Field(default='https://schema.org/MedicalConditionStage', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
