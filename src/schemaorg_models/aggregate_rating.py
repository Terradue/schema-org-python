...
The average rating based on multiple ratings or reviews.
    """
    class_: Literal['https://schema.org/AggregateRating'] = Field(default='https://schema.org/AggregateRating', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
