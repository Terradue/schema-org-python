...
or Fast and expensive: $15 in 1-2 days.
    """
    class_: Literal['https://schema.org/OfferShippingDetails'] = Field(default='https://schema.org/OfferShippingDetails', alias='class', serialization_alias='class') # type: ignore
