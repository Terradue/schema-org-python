...
or Fast and expensive: $15 in 1-2 days.
    """
    class_: Literal['https://schema.org/OfferShippingDetails'] = Field(default='https://schema.org/OfferShippingDetails', alias='@type', serialization_alias='@type') # type: ignore
