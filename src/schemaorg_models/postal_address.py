...
The mailing address.
    """
    class_: Literal['https://schema.org/PostalAddress'] = Field(default='https://schema.org/PostalAddress', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
