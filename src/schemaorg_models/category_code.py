...
A Category Code.
    """
    class_: Literal['https://schema.org/CategoryCode'] = Field(default='https://schema.org/CategoryCode', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
