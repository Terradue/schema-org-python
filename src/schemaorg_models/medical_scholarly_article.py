...
A scholarly article in the medical domain.
    """
    type_: Literal['https://schema.org/MedicalScholarlyArticle'] = Field(default='https://schema.org/MedicalScholarlyArticle', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
