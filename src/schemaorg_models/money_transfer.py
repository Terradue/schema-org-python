...
The act of transferring money from one place to another place. This may occur electronically or physically.
    """
    type_: Literal['https://schema.org/MoneyTransfer'] = Field(default='https://schema.org/MoneyTransfer', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
