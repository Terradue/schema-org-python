...
A screening of a movie or other video.
    """
    type_: Literal['https://schema.org/ScreeningEvent'] = Field(default='https://schema.org/ScreeningEvent', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
