...
A software application designed specifically to work well on a mobile device such as a telephone.
    """
    type_: Literal['https://schema.org/MobileApplication'] = Field(default='https://schema.org/MobileApplication', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
