...
The price for the delivery of an offer using a particular delivery method.
    """
    class_: Literal['https://schema.org/DeliveryChargeSpecification'] = Field(default='https://schema.org/DeliveryChargeSpecification', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
