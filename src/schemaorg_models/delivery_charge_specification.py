...
The price for the delivery of an offer using a particular delivery method.
    """
    class_: Literal['https://schema.org/DeliveryChargeSpecification'] = Field(default='https://schema.org/DeliveryChargeSpecification', alias='class', serialization_alias='class') # type: ignore
