...
The price for the delivery of an offer using a particular delivery method.
    """
    class_: Literal['https://schema.org/DeliveryChargeSpecification'] = Field(default='https://schema.org/DeliveryChargeSpecification', alias='@type', serialization_alias='@type') # type: ignore
