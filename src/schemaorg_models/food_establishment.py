...
A sub property of location. The specific food establishment where the action occurred.
    """
    type_: Literal['https://schema.org/FoodEstablishment'] = Field(default='https://schema.org/FoodEstablishment', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
