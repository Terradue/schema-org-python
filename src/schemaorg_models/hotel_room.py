...
See also the <a href="/docs/hotels.html">dedicated document on the use of schema.org for marking up hotels and other forms of accommodations</a>.
    ...
    """
    type_: Literal['https://schema.org/HotelRoom'] = Field(default='https://schema.org/HotelRoom', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
