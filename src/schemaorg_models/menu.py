...
A structured representation of food or drink items available from a FoodEstablishment.
    """
    class_: Literal['https://schema.org/Menu'] = Field(default='https://schema.org/Menu', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
