...
See also [blog post](https://blog-schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/).
    """
    type_: Literal['https://schema.org/PublicationIssue'] = Field('class', alias=AliasChoices('@type', 'https://schema.org/PublicationIssue'),serialization_alias='class') # type: ignore
