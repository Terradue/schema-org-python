...
The act of participating in performance arts.
    """
    type_: Literal['https://schema.org/PerformAction'] = Field(default='https://schema.org/PerformAction', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
