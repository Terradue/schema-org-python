...
One or more detailed price specifications, indicating the unit price and delivery or payment charges.
    """
    type_: Literal['https://schema.org/PriceSpecification'] = Field(default='https://schema.org/PriceSpecification', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
