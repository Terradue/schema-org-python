...
A musical group, such as a band, an orchestra, or a choir. Can also be a solo musician.
    """
    class_: Literal['https://schema.org/MusicGroup'] = Field(default='https://schema.org/MusicGroup', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
