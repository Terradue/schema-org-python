...
A type of financial product that typically requires the client to transfer funds to a financial service in return for potential beneficial financial return.
    """
    class_: Literal['https://schema.org/InvestmentOrDeposit'] = Field(default='https://schema.org/InvestmentOrDeposit', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
