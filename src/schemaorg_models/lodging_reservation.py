...
Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations.
    """
    class_: Literal['https://schema.org/LodgingReservation'] = Field(default='https://schema.org/LodgingReservation', alias='class', serialization_alias='class') # type: ignore
