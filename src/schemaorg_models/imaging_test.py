...
Any medical imaging modality typically used for diagnostic purposes.
    """
    type_: Literal['https://schema.org/ImagingTest'] = Field(default='https://schema.org/ImagingTest', alias='@type', serialization_alias='http://www.w3.org/2000/01/rdf-schema#/Class') # type: ignore
