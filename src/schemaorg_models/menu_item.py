...
A food or drink item listed in a menu or menu section.
    """
    class_: Literal['https://schema.org/MenuItem'] = Field(default='https://schema.org/MenuItem', alias='http://www.w3.org/2000/01/rdf-schema#Class', serialization_alias='http://www.w3.org/2000/01/rdf-schema#Class') # type: ignore
